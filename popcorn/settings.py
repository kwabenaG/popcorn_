...
SECRET_KEY = 'd@evtp56+-1h3^bjoky)uly4p!hey_9qw)i6e+((b&p7kxio8!'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates'), os.path.join(BASE_DIR, 'templates', 'emails_temp')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # do not put  media_root directory in a list or tuple
...
EMAIL_HOST_USER = '9873d21b2674ea'
EMAIL_HOST_PASSWORD = '13b86555ac3de7'
EMAIL_PORT = '2525'
